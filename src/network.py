...
class FeatureExtractor:
    ...
    def __call__(self, images, input_feature=None):
        """
        Arguments:
        ...
        def batch_norm(input_x):
            input_x = tf.layers.batch_normalization(
                input_x, axis=3, center=True, scale=True,
        ...
        if input_feature is None:
            ...
            # multiple scale convolutional layers before get_feature
            params = {
        ...
        with slim.arg_scope([slim.conv2d], **params):
            features = [x]  # extracted feature maps
